...
.Day {
  @apply box-border flex h-full min-h-20 w-full cursor-pointer select-none flex-col items-start justify-between border-l border-t border-outline p-3 text-lg leading-3 tracking-tight transition-all;
