...
.WeekView {
  @apply flex w-full flex-col items-center justify-between gap-y-2 max-sm:box-border max-sm:h-[68svh] max-sm:w-full max-sm:flex-nowrap max-sm:items-start max-sm:overflow-x-scroll max-sm:overflow-y-scroll;
}
</style>
